...
const Globe = dynamic(() => import('react-globe.gl'), { 
    ssr: false,
    loading: () => <div className="w-full h-full flex items-center justify-center bg-[#050505] text-[#119dff]/50 font-rajdhani text-sm tracking-widest animate-pulse">Initializing Global Matrix...</div>
});
        ...
        <div ref={containerRef} className="w-full h-full absolute inset-0">
            {dimensions.width > 0 && (
                <Globe
                    ...
                    atmosphereColor={currentTheme.color}
                    ...
                    pointLat="lat"
                    pointLng="lng"
                    pointColor={(d: any) => d.slug === hoveredCity ? currentTheme.color : `${currentTheme.color}88`}
                    ...
                    pointLabel={(point: any) => `
                        <div class="bg-black/90 backdrop-blur-md border rounded-lg px-3 py-2 shadow-lg -mt-16 pointer-events-none" style="border-color: ${currentTheme.color}4d; box-shadow: 0 0 20px ${currentTheme.color}80;">
                            <div class="text-[10px] font-rajdhani font-bold tracking-widest" style="color: ${currentTheme.color}">${point.country.toUpperCase()}</div>
