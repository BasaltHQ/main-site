        ...
        <div className="w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 px-2">
                <div className="flex items-center gap-2">
                    <span className="text-sm font-mono text-primary tracking-widest uppercase flex items-center gap-2">
                ...
                <div className="w-full md:w-96 relative">
                    <input 
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white font-sans focus:outline-none focus:border-primary/50 transition-colors"
                    />
                ...
                <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {displayLocations.map((loc: any, idx: number) => (
                        <Link
                            ...
                            className="group bg-black/40 p-5 rounded-2xl border border-white/5 hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 block hover:shadow-[0_0_20px_var(--glow-color)] relative overflow-hidden"
                        >
                            ...
                            <div className="flex justify-between items-start mb-2 relative z-10">
                                <h2 className="text-xl font-bold group-hover:text-primary transition-colors">{loc.name}</h2>
                            </div>
                            <div className="flex items-center gap-2 mb-4 relative z-10">
                                <span className="text-[10px] font-mono text-white/40 border border-white/10 px-2 py-0.5 rounded uppercase">
                                    {loc.country}
                                </span>
                                <span className="text-[10px] font-mono text-primary/80 px-2 py-0.5 bg-primary/10 rounded uppercase">
                                    ACTIVE
                                </span>
                            </div>
                            <div className="flex items-center text-primary text-xs font-bold tracking-widest uppercase relative z-10">
