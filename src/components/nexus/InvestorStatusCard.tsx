...
import { getCurrentUserInvestorStatus } from '@/app/nexus/actions'
...
export default function InvestorStatusCard() {
    ...
    useEffect(() => {
        async function fetchStatus() {
            try {
                const investorStatus = await getCurrentUserInvestorStatus()
        ...
        <div className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            ...
            <div className="flex items-center justify-between mb-6 pb-6 border-b border-white/10">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-[#119dff]/20 flex items-center justify-center">
                        <Shield className="text-[#119dff]" size={24} />
                    </div>
                    <div>
            ...
            <div className="space-y-6">
                ...
                {status.investmentLimit && (
                    <div className="bg-gradient-to-br from-[#119dff]/10 to-[#119dff]/5 border border-[#119dff]/20 rounded-xl p-6">
                            ...
                            <div className="flex-1">
                                ...
                                {status.accreditationStatus === 'unknown' && (
                                    <Link
                                        ...
                                        className="inline-block px-6 py-2 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all text-sm font-medium"
                                    >
                                        Start Accreditation
                                    </Link>
                                )}
