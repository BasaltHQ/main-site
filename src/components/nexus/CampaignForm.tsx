        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white/5 border border-white/10 p-6 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-[#119dff] outline-none transition-colors"
                        required
                    />
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-black/50 border border-white/10 rounded-lg pl-10 pr-4 py-3 text-white focus:border-[#119dff] outline-none transition-colors"
                            required
                        />
                    </div>
                </div>
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-[#119dff] outline-none transition-colors h-32"
                    />
                </div>
            </div>
            ...
            <div className="flex justify-end gap-4 pt-4 border-t border-white/5">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-2 bg-[#119dff] hover:bg-[#0d7acc] text-white text-sm font-semibold rounded-lg transition-colors flex items-center gap-2"
                >
