...
export default function FinancialWizard({ subsidiaryId, onClose, onComplete }: FinancialWizardProps) {
    ...
    const calculateMetrics = () => {
        ...
        return { arr, monthly_burn_rate: burnRate, runway_months: runway, expense_runway_months: expenseRunway, rule_of_40: ruleOf40, ltv_cac_ratio: ltvCac }
    }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await fetch('/api/nexus/financials', {
                method: 'POST',
