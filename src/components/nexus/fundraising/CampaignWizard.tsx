            ...
            <div className="bg-[#0A0A0A] border border-white/10 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="flex gap-2 px-6 pt-6">
                    {[1, 2, 3].map(s => (
                        <div
                            key={s}
                            className={`flex-1 h-1 rounded-full transition-all ${s <= step ? 'bg-[#119dff]' : 'bg-white/10'
                                }`}
                        />
                    ))}
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6">
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                    <Target className="text-[#119dff]" size={24} />
                                    Campaign Basics
                                </h3>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-3 text-white outline-none focus:border-[#119dff] transition-colors"
                                />
                            </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                    <Calendar className="text-[#119dff]" size={24} />
                                    Timeline
                                </h3>
                            </div>
                ...
                <div className="flex items-center justify-between gap-4 p-6 border-t border-white/10">
                    ...
                    {step < 3 ? (
                        <button
                            ...
                            className="px-8 py-3 bg-[#119dff] hover:bg-[#119dff]/90 disabled:bg-white/10 disabled:text-white/40 text-white font-bold rounded-lg transition-all flex items-center gap-2"
                        >
                            Next
                            <ArrowRight size={20} />
                        </button>
