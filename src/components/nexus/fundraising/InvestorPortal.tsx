...
import { getInvestorPortalData } from '@/app/nexus/actions'
...
export default function InvestorPortal() {
    ...
    return (
        <div className="space-y-8">
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-[#119dff]/20 via-purple-500/10 to-black/40 border border-[#119dff]/30 rounded-2xl p-12">
                ...
                <div className="col-span-8 space-y-6">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                        <h2 className="text-2xl font-bold text-white mb-6 font-rajdhani flex items-center gap-3">
                            <PieChart className="text-[#119dff]" size={32} />
                            My Investments
                        </h2>
                            ...
                            {investments.map((investment, idx) => (
                                ...
                                >
                                    ...
                                    <div className="flex gap-3 mt-4">
                                        <button className="flex-1 px-4 py-2 bg-[#119dff]/20 hover:bg-[#119dff]/30 text-[#119dff] rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2">
                                            <Download size={16} />
                                            Certificate
                                        </button>
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                        <h2 className="text-2xl font-bold text-white mb-6 font-rajdhani flex items-center gap-3">
                            <Bell className="text-[#119dff]" size={32} />
                            Recent Updates
                        </h2>
                ...
                <div className="col-span-4 space-y-6">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
                        ...
                        <div className="bg-white/5 rounded-lg p-4">
                            <p className="text-[#119dff] font-bold mb-2">Series B Fundraise</p>
                            <p className="text-white/60 text-sm mb-3">Target: Q2 2025</p>
                            <div className="h-1.5 bg-black/40 rounded-full overflow-hidden">
                                <div className="h-full bg-[#119dff]" style={{ width: '65%' }} />
                            </div>
