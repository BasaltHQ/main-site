                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4 justify-between pt-6">
                                ...
                                <button
                                    ...
                                    className="px-8 py-3 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed font-medium"
                                >
                                    Continue to Consent
                                </button>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <label className="flex items-start gap-3 cursor-pointer group">
                                <input
                                    ...
                                    className="w-5 h-5 mt-0.5 accent-[#119dff] cursor-pointer"
                                />
                    ...
                    {step === 'complete' && (
                        <div className="space-y-6 text-center py-12">
                            ...
                            <div className="flex gap-4 justify-center pt-6">
                                <button
                                    onClick={downloadDocument}
                                    className="flex items-center gap-2 px-6 py-3 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all"
                                >
                                    <Download size={18} />
