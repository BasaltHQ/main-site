            ...
            {signatureMode === 'type' && (
                <div className="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        className="px-4 py-3 bg-black/40 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:border-[#119dff] focus:outline-none transition-colors"
                    />
                </div>
            )}
            ...
            <div className="flex gap-4 justify-between">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={isEmpty}
                        className="flex items-center gap-2 px-8 py-3 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed font-medium"
                    >
                        <Check size={18} />
                        Save Signature
                    </button>
