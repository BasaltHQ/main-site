...
import { Proposal, getVotingResults, hasUserVoted, getProposalById } from '@/lib/cap-table-governance'
        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-fadeIn">
            ...
            <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                <h2 className="text-2xl font-bold text-white mb-6 font-rajdhani flex items-center gap-3">
                    <Users className="text-[#119dff]" size={28} />
                    Proposed Changes
                </h2>
            ...
            {dilutionStakeholders.length > 0 && (
                <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                    <h2 className="text-2xl font-bold text-white mb-6 font-rajdhani flex items-center gap-3">
                        <TrendingDown className="text-[#119dff]" size={28} />
                        Dilution Impact
                    </h2>
            ...
            {proposal.status === 'voting' && !userHasVoted && (
                <div className="bg-gradient-to-r from-[#119dff]/20 to-purple-500/20 border border-[#119dff]/30 rounded-2xl p-8">
                    <div className="flex items-start gap-4 mb-6">
                        <AlertTriangle className="text-[#119dff] flex-shrink-0" size={32} />
                        <div>
                    ...
                    <button
                        ...
                        className="w-full px-8 py-4 bg-[#119dff] hover:bg-[#119dff]/90 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-3"
                    >
                        <CheckCircle size={24} />
                        Cast Your Vote
                    </button>
