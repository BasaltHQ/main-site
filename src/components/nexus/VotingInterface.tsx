        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                    <div
                        className="h-full bg-[#119dff] transition-all duration-300"
            ...
            <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                ...
                {step === 2 && userStakeholder && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/5 rounded-lg p-6">
                            ...
                            <div className="text-center p-6 bg-gradient-to-r from-[#119dff]/10 to-purple-500/10 border border-[#119dff]/30 rounded-lg">
                        ...
                        <div className="space-y-4">
                            <label className="flex items-start gap-3 p-4 bg-white/5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors">
                                <input
                                    ...
                                    className="mt-1 w-5 h-5 accent-[#119dff]"
                                />
                                <div>
                            ...
                            <label className="flex items-start gap-3 p-4 bg-gradient-to-r from-[#119dff]/10 to-purple-500/10 border border-[#119dff]/30 rounded-lg">
                                <input
                                    type="checkbox"
                ...
                {step === 6 && (
                    <div className="space-y-6">
                        ...
                        <textarea
                            ...
                            className="w-full h-40 px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/40 focus:border-[#119dff] focus:outline-none resize-none"
                        />
                ...
                {step === 7 && (
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 mb-6">
                            <Pen className="text-[#119dff]" size={32} />
                ...
                <div className="flex justify-between mt-8 pt-6 border-t border-white/10">
                    ...
                    {step < totalSteps && (
                        <button
                            ...
                            className="px-8 py-3 bg-[#119dff] hover:bg-[#119dff]/90 disabled:bg-white/10 disabled:text-white/40 text-white font-bold rounded-lg transition-all ml-auto"
                        >
                            Continue
                        </button>
                    )}
                    ...
                    {step === totalSteps && (
                        <button
                            ...
                            className="px-8 py-3 bg-[#119dff] hover:bg-[#119dff]/90 disabled:bg-white/10 disabled:text-white/40 text-white font-bold rounded-lg transition-all ml-auto flex items-center gap-2"
                        >
