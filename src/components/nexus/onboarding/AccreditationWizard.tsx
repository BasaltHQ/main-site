                                    ...
                                    <div className="flex flex-col items-center flex-1">
                                        <div
                                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isComplete
                                                ...
                                                : isActive
                                                    ? 'bg-[#119dff] text-white ring-4 ring-[#119dff]/20'
                ...
                <div className="flex justify-between mt-8">
                    ...
                    {currentStep === STEPS.length - 1 ? (
                        ...
                        <button
                            onClick={nextStep}
                            disabled={!canProceed()}
                            className="flex items-center gap-2 px-6 py-3 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed font-medium"
                        >
                            Continue
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4 pb-6 border-b border-white/10">
                <User className="text-[#119dff]" size={32} />
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {types.map(({ value, label, icon: Icon, description }) => (
                    ...
                    >
                        <Icon
                            className={`mb-4 ${responses.investorType === value ? 'text-[#119dff]' : 'text-white/40'
                                }`}
                            size={32}
                        />
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        placeholder="200,000"
                        className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:border-[#119dff] focus:outline-none transition-colors"
                    />
...
function Step4Credentials({ responses, updateResponse }: StepProps) {
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4 pb-6 border-b border-white/10">
                <Award className="text-[#119dff]" size={32} />
                <div>
            ...
            <div className="space-y-4">
                <label className="flex items-center gap-3 cursor-pointer group">
                    <input
                        ...
                        className="w-5 h-5 accent-[#119dff] cursor-pointer"
                    />
                ...
                {responses.hasSeriesLicense && (
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-lg text-white focus:border-[#119dff] focus:outline-none transition-colors"
                        >
...
function Step5EntityInfo({ responses, updateResponse }: StepProps) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4 pb-6 border-b border-white/10">
                <Building className="text-[#119dff]" size={32} />
                <div>
...
function Step7Summary({ responses, determination, uploadedDocuments }: SummaryStepProps) {
    ...
    return (
        <div className="space-y-6">
                ...
                <ul className="space-y-2">
                    {determination.reasoning.map((reason: string, i: number) => (
                        <li key={i} className="flex items-start gap-2 text-sm text-white/80">
                            <span className="text-[#119dff] mt-1">•</span>
                            <span>{reason}</span>
                        </li>
                    ))}
                </ul>
            ...
            {/* Next Steps */}
            <div className="bg-[#119dff]/10 border border-[#119dff]/20 rounded-lg p-6">
                <h3 className="text-[#119dff] font-bold mb-3">Next Steps:</h3>
