    ...
    if (!token) {
        return (
            <div className="text-center">
                ...
                <Link href="/nexus/forgot-password" className="text-[#119dff] hover:text-white transition-colors flex items-center justify-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:border-[#119dff] focus:outline-none transition-colors"
                    placeholder="••••••••"
                    required
                    minLength={8}
                />
            ...
            <button
                ...
                className="w-full py-3 bg-[#119dff] hover:bg-[#119dff]/90 disabled:bg-white/10 disabled:text-white/40 text-white font-bold rounded-lg transition-colors flex items-center justify-center gap-2"
            >
