        ...
        <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h1 className="text-4xl font-bold text-white font-rajdhani mb-2 tracking-wide uppercase flex items-center gap-4">
                    <Landmark className="text-[#119dff]" size={36} /> Treasury Operations
                </h1>
                <p className="text-white/60">Manage corporate fiat and digital assets.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                <div className="bg-gradient-to-br from-[#119dff]/20 to-black/40 border border-[#119dff]/30 p-8 rounded-2xl shadow-[0_0_30px_rgba(17,157,255,0.1)]">
                    <p className="text-[#119dff] text-xs font-bold uppercase tracking-widest mb-2">Total Treasury Value</p>
                ...
                <div className="bg-black/40 border border-white/10 p-8 rounded-2xl group hover:border-[#119dff]/30 transition-colors">
            ...
            <div className="bg-black/50 border border-white/10 rounded-2xl overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#119dff] to-transparent opacity-50" />
                ...
                <div className="p-8">
                    {offrampStep === 0 && (
                        <div className="max-w-xl">
                            <label className="block text-xs font-bold text-[#119dff] uppercase tracking-widest mb-3 flex items-center gap-2">
                            ...
                            <div className="flex gap-4">
                                <input 
                                    ...
                                    className="flex-1 bg-black/50 border border-white/10 rounded-xl px-6 py-4 text-2xl font-rajdhani text-white focus:outline-none focus:border-[#119dff] transition-all"
                                    placeholder="500,000"
                                />
                                <button 
                                    onClick={() => setOfframpStep(1)}
                                    disabled={!offrampAmount || parseFloat(offrampAmount) <= 0}
                                    className="px-8 bg-gradient-to-r from-[#119dff] to-[#0d7acc] hover:from-[#3db3ff] hover:to-[#119dff] text-white font-bold uppercase tracking-widest rounded-xl disabled:opacity-30 transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(17,157,255,0.4)]"
                                >
                            ...
                            <div className="bg-black/30 border border-white/5 rounded-xl p-6 mb-6">
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    <div className="flex justify-between items-center pb-2 border-b border-white/5">
                                        ...
                                        <span className="text-[#119dff] font-bold">${parseFloat(offrampAmount).toLocaleString()}</span>
                                    </div>
                                    <div className="flex justify-between items-center pb-2 border-b border-white/5">
