...
import { getCampaignById, getTransactionsByCampaign, getIntegrationByKey } from '@/app/nexus/actions';
        ...
        <div className="space-y-8 animate-fadeIn pb-20">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className={`px-3 py-1 text-xs uppercase tracking-wider font-bold rounded-full border shadow-[0_0_15px_rgba(0,0,0,0.3)] ${campaign.status === 'active'
                                ? 'bg-[#119dff]/10 text-[#119dff] border-[#119dff]/20'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {/* Performance Card */}
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-8 relative overflow-hidden backdrop-blur-sm group hover:border-[#119dff]/20 transition-colors">
                        <div className="absolute top-0 right-0 w-80 h-80 bg-[#119dff]/5 rounded-full blur-[100px] pointer-events-none group-hover:bg-[#119dff]/10 transition-colors duration-500" />

                        <h3 className="text-xl font-bold font-rajdhani text-white mb-8 flex items-center gap-3">
                            <div className="p-2 rounded-lg bg-[#119dff]/10 border border-[#119dff]/20">
                                <DollarSign className="text-[#119dff]" size={20} />
                            </div>
                        ...
                        <div className="mb-10">
                            <div className="flex flex-wrap justify-between items-end mb-4 gap-4">
                                ...
                                <div className="text-right">
                                    <p className="text-3xl font-bold text-[#119dff]">{Math.round(progress)}%</p>
                            ...
                            <div className="h-3 bg-white/5 rounded-full overflow-hidden border border-white/5">
                                <div
                                    className="h-full bg-gradient-to-r from-[#119dff] to-[#0a5c99] relative transition-all duration-1000 ease-out shadow-[0_0_20px_rgba(245,64,41,0.5)]"
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-lg font-bold font-rajdhani text-white flex items-center gap-2">
                                <CreditCard className="text-[#119dff]" size={20} />
                                Investor Ledger
                            </h3>
                                                ...
                                                <td className="py-4 pl-2">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center text-xs font-bold text-white border border-white/10">
                                                            {(tx.investor_id?.full_name || 'U').charAt(0)}
                                                        </div>
                                                        <div>
                                                            <p className="text-white font-medium">{tx.investor_id?.full_name || 'Unknown'}</p>
                                                            <p className="text-[10px] text-white/30">{formatDistanceToNow(new Date(tx.created_at || new Date()))}</p>
                                                        </div>
                                                    </div>
                                                </td>
                ...
                <div className="space-y-6">
                    {/* Wallet Card */}
                    <div className="bg-gradient-to-b from-[#1A1A1A] to-black border border-white/10 border-t-[#119dff]/50 rounded-2xl p-6 shadow-2xl relative overflow-hidden group">
                        ...
                        <h3 className="text-sm font-bold font-rajdhani text-white uppercase tracking-wider mb-6 flex items-center gap-2 relative z-10">
                            <Wallet size={16} className="text-[#119dff]" />
                            Funding Designation
                        </h3>
                        ...
                        <div className="relative z-10">
                            ...
                            <div
                                onClick={handleCopy}
                                className="bg-black/50 border border-white/10 hover:border-[#119dff]/50 rounded-xl p-4 flex items-center justify-between gap-3 cursor-pointer transition-all group/wallet"
                            >
                            ...
                            {walletAddress ? (
                                ...
                                <Link href="/nexus/settings" className="block text-[10px] text-[#119dff] mt-2 text-center hover:underline">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10 relative z-10">
                            <button className="w-full py-4 bg-[#119dff] hover:bg-[#0d7acc] text-white font-bold rounded-xl uppercase tracking-widest shadow-[0_0_20px_rgba(245,64,41,0.2)] hover:shadow-[0_0_30px_rgba(245,64,41,0.4)] transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
                        <h3 className="text-sm font-bold font-rajdhani text-white uppercase tracking-wider mb-4 flex items-center gap-2">
                            <Settings size={16} className="text-[#119dff]" />
                            Admin Controls
                        </h3>
                    ...
                    {campaign.terms_url && (
                        <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
                            <a
                                ...
                                className="block p-4 rounded-xl bg-white/5 border border-white/5 hover:border-[#119dff]/30 transition-all group"
                            >
                                <div className="flex items-center gap-4">
                                    <div className="p-2 bg-white/5 rounded-lg text-white/40 group-hover:text-[#119dff] transition-colors">
                                        <FileText size={20} />
                                    </div>
                                    <div>
                                        <p className="text-sm text-white font-bold group-hover:text-[#119dff] transition-colors">Deal Memo</p>
