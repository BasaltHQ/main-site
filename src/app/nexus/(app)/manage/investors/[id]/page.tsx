...
import { ArrowLeft, User, Mail, Briefcase, Calendar, Shield, Activity, FileText, Check, X, Building, Ban, Phone, ExternalLink } from 'lucide-react';
import { formatDistanceToNow, format } from 'date-fns';
import { getProfileById, updateProfileStatus, updateProfileRole } from '@/app/nexus/actions';
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row justify-between md:items-start gap-6">
                    <div className="flex items-start gap-6">
                        <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#119dff] to-orange-800 flex items-center justify-center text-white font-bold text-4xl shadow-[0_0_30px_rgba(245,64,41,0.3)] border border-white/10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
                        <h3 className="text-sm font-bold font-rajdhani text-white uppercase tracking-wider mb-6 flex items-center gap-2">
                            <User size={16} className="text-[#119dff]" />
                            Profile Details
                        </h3>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-8">
                        ...
                        <textarea
                            className="w-full bg-black/50 border border-white/10 rounded-xl p-4 text-white/80 h-32 focus:border-[#119dff] outline-none transition-colors resize-none"
