...
import { updateInvestorProfile } from '@/app/nexus/actions'
...
export default function OnboardingPage() {
    ...
    const handleIdentityComplete = async (data: any) => {
        ...
        try {
            await updateInvestorProfile(data)
        } catch (error) {
    ...
    return (
        <div className="max-w-3xl mx-auto px-4">
            <div className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-12 text-center">
                <Flag className="text-[#119dff] mx-auto mb-6" size={64} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="p-6 bg-white/5 rounded-xl">
                        <User className="text-[#119dff] mx-auto mb-3" size={32} />
                    ...
                    <div className="p-6 bg-white/5 rounded-xl">
                        <CheckCircle className="text-[#119dff] mx-auto mb-3" size={32} />
                    ...
                    <div className="p-6 bg-white/5 rounded-xl">
                        <PenTool className="text-[#119dff] mx-auto mb-3" size={32} />
                ...
                <button
                    onClick={onContinue}
                    className="px-12 py-4 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all font-medium text-lg"
                >
                    Begin Onboarding
                </button>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4">
            <div className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-lg text-white focus:border-[#119dff] focus:outline-none"
                            />
                        </div>
                    ...
                    <button
                        type="submit"
                        className="w-full py-4 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all font-medium"
                    >
        ...
        <div className="max-w-3xl mx-auto px-4">
            <div className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-12 text-center">
                ...
                <a
                    ...
                    className="inline-block px-12 py-4 bg-[#119dff] hover:bg-[#119dff]/90 text-white rounded-lg transition-all font-medium"
                >
                    Go to Dashboard
                </a>
            </div>
