...
export const metadata: Metadata = {
  title: "Integrations – BasaltHQ",
  description: "Connect Basalt to POS, ERP, HRIS, messaging, and analytics stacks. Toast, 7shifts, QuickBooks, Square, Slack, Teams, and more.",
  alternates: { canonical: "https://basalt.com/integrations" },
  openGraph: {
    title: "Integrations – BasaltHQ",
    description: "Connect Basalt to POS, ERP, HRIS, messaging, and analytics stacks.",
    url: "https://basalt.com/integrations",
    type: "website",
  },
  twitter: {
